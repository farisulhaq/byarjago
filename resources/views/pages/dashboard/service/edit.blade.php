...
<main class="h-full overflow-y-auto">
    ...
    <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
        <ol class="inline-flex p-0 list-none">
            ...
            <li class="flex items-center">
                <a href="#" class="font-medium">Edit Your Class</a>
            </li>
        </ol>
    </nav>
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 -mb-6">
                                        <label for="estimation & revision" class="block mb-3 font-medium text-gray-700 text-md">Estimasi Class & Jumlah Class</label>
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <select id="revision_limit" name="revision_limit" autocomplete="revision_limit" class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                            <option>Maksimal Class</option>
                                            <option>Butuh Berapa hari Class kamu selesai?</option>
                                            <option value="2" {{ $service->revision_limit == '2' ? 'selected' : '' }}>2 Class</option>
                                            <option value="5" {{ $service->revision_limit == '5' ? 'selected' : '' }}>4 Class</option>
                                            <option value="7" {{ $service->revision_limit == '7' ? 'selected' : '' }}>8 Class</option>
                                            <option value="10" {{ $service->revision_limit == '10' ? 'selected' : '' }}>16 Class</option>
                                            <option value="12" {{ $service->revision_limit == '12' ? 'selected' : '' }}>32 Class</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-span-6">
                                        <label for="service-name" class="block mb-3 font-medium text-gray-700 text-md">Thumbnail Class Feeds</label>
